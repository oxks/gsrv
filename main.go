...
func main() {
	...
	var dbURL string
	var dev bool
	flag.StringVar(&dbURL, "db", "postgres://postgres:secretpass@localhost:54320?database=dablopipe", "The Database connection URL")
	...
	flag.BoolVar(&cfg.EnableGrpcUI, "grpcui", true, "Serve gRPC Web UI")
